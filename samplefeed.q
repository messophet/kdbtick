...
.z.ts:{
 s:n?syms;
 $[0<flag mod 10;
  h(".u.upd";`quote;(n#.z.N;s;getbid'[s];getask'[s];n?1000;n?1000;first each string n?1;first each string n?1));
  h(".u.upd";`trade;(n#.z.N;s;getprice'[s];n?1000;n?1b;first each string n?10;first each string n?10))
 ];
 flag+:1;
 };
